...
import { RiAddBoxLine, RiDeleteBin3Line, RiEdit2Line, RiSearchLine } from "react-icons/ri";
...
export function ListOrganismes({organismes, searching}: ListOrganismesProps) {
